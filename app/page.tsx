          ...
          <div className="flex flex-col md:flex-row items-center md:items-start">
            ...
            <div className="textarea flex-1 flex flex-col justify-between">
              ...
              <p className="items-center md:w-3/4 ml-4 text-white mb-4">
                2002年5月30日、大阪出身。2021年より大阪府立大学（現大阪公立大学）に入学、知能メディア処理研究グループ所属。2025年から大阪公立大学大学院に進学予定。2025年3月のEngineer
                Guild
                Hackathonで3位入賞。TOEIC860点（2024年4月）。趣味は謎解き（制作も含む）、ゲーム。デザインとゲーム制作を勉強中。
              </p>
